...
import utils.box_ops

boxes1 = np.array([101.2182,  78.7248, 126.8039,  78.0229, 128.9385, 107.7787, 102.5079,
        109.4263])
boxes2 = np.array([ 90,  93, 107,  86, 115, 106,  98, 113])

boxes1 = [round(num) for num in boxes1]
